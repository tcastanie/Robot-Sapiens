/*
 * UpdateRoles.java - Created on Jan 31, 2004
 * 
...
interface UpdateRoles {
	public static String community="MadkitUpdate";
	public static String group="updater";
	
	public static String DOWNLOADER="downloader";
	public static String PROGRESS="progress";
	public static String PLUGIN_MANAGER="pluginManagerAgent";
