...
//	--------- MODIF KENDY MOUSEWHEEL 30 mars 2004-------[[
import jsynedit.search.UUtilities;
import java.lang.reflect.Method;
import jedit.textarea.JavaSupport;
//	--------- MODIF KENDY MOUSEWHEEL 30 mars 2004-------]]
 ...
 *
 * @author Slava Pestov
 * @version $Id: JEditTextArea.java,v 1.1 2004/05/05 10:44:27 jferber Exp $
 */
public class JEditTextArea extends JComponent
{
	...
	/**
	 * Enables using of mousewheel
	 */
	private void setMouseWheel()
	{
		if (UUtilities.JDK_VERSION.charAt(2) >= '4')
		{
			try
			{
				 Class cl = Class.forName("jedit.textarea.JavaSupport");
			...
			{ 
 				System.out.println("EXCEPTION DETECTEE="+e);
 			}
		}
   }
