...
public class Search
{
  ...
  public static SearchMatcher getSearchMatcher(boolean reverseOK) throws Exception
  {
    ...
    public static boolean find(/*JextTextArea*/ JEditTextArea textArea, final int start) throws Exception
  {
    ...
    public static boolean replace(/*JextTextArea*/JEditTextArea textArea)
    {
    ...
    public static int replaceAll(/*JextTextArea*/JEditTextArea textArea, int start, int end) throws Exception
    {
	if (!textArea.isEditable())
      return 0;
