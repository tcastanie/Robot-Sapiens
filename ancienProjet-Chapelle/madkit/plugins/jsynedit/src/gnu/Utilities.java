...
//import gnu.misc.SwingWorker;
////import gnu.misc.HandlingRunnable;
//import gnu.misc.CopyThread;
//import gnu.misc.DownloaderThread;
import jsynedit.*;
...
public class Utilities
{
  ...
  {
    JOptionPane.showMessageDialog(null, message, /*Jext*/AbstractEditorPanel.getProperty("utils.message"),
  ...
  {
    JOptionPane.showMessageDialog(null, message, /*Jext*/AbstractEditorPanel.getProperty("utils.error"),
...
/*
  ...
  {
    return /*JextAbstractDoc.getMyToolkit().getScreenSize();
  }
...
out2:   for (int i = second + 1; i < len; i++)
   ...
   * @link{#copy(java.io.InputStream,java.io.OutputStream,boolean,gnu.misc.HandlingRunnable)} passing a null 
   ...
   * @since Jext 3.2pre4
   * @deprecated maybe, use the version with a CopyThread as second parameter instead(I think it's cleaner, this
