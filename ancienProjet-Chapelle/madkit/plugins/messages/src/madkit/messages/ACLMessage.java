/*
* ACLMessage.java - Message library of MadKit
...
public class ACLMessage extends ActMessage
{
  ...
  public static List performatives = new ArrayList(22);
  ...
  */
  ...
  public ACLMessage(int perf, String cont){
      super((String) performatives.get(perf),cont);
  }
...
*/
  ...
  public ACLMessage createReply() {
    ...
    } else for (Iterator it = reply_to.iterator();it.hasNext();){
        m.addReceiver((AgentAddress)it.next());
    }
  ...
  {
      // small test
      ACLMessage m = new ACLMessage("tell");

      m.setLanguage("KIF");
      m.setOntology("cook");
      m.setProtocol("cuisine-net");
      m.setEnvelope("PGP-env");
      m.setConversationID("42");
      m.setReplyWith("q2");
      m.setReplyBy(new Date());
