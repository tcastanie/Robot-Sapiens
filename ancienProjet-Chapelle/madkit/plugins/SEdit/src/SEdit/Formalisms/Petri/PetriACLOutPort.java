/*
* PetriACLOutPort.java - SEdit, a tool to design and animate graphs in MadKit
...
public class PetriACLOutPort extends PetriOutPort {


	public PetriACLOutPort(){
		setMessageType("ACL");
	}
	...
	public void produce(Object e) {
		...
		//  		getStructure().getAgent().sendToRecipient(m);
  		getStructure().getAgent().doSendMessage(getStructure().getAgent().getRecipient(),
							m);
