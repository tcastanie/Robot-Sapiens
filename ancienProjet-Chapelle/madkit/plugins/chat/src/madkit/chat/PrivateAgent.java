/*
* PrivateAgent.java - ChatAgent, a chat application for MadKit
 ...
 * Description :  PrivateAgent, allows the chatter to chat in private in one way. Control part.
...
public class PrivateAgent extends Agent {
    ...
    public PrivateAgent(AgentAddress a,String autr,String nick)
    {	
	nickname1=nick;
	autre1=autr;
	ab=a;
	...
	int r3 = requestRole("Chat","private",autre1+"-"+nickname1,null);   //test
    }
    ...
    public void sendPrivateMessage(String s)
    {
	
	AgentAddress[] agList = getAgentsWithRole("Chat","private",autre1+"-"+nickname1);
