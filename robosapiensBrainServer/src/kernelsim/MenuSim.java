...
public class MenuSim extends JPanel implements ActionListener{
	//@SuppressWarnings("unused")
	//051018nl private int lastx,lasty,fx,fy;
 ...
 public MenuSim(int sx, int sy,RmcLauncherApp p)
 ...
 public void setSize(int x,int y)
    {
    	System.out.println("MenuSim:setSize("+x+","+y+")");
        super.setSize(x,y);
    }
