...
public  void init_coord(int x, int y)
 ...
 void initialisation(int x,int y,String g,int nr,byte N_agent,int TypeRob)
	{
		//this.x=x; this.y=y;
...
*/
 ...
 public void end()
  {
	 leaveRole(Global.Community,simulationGroup,"Robot");
...
{
     return null;
    		 //world.capteursIR(this,dir,ouv,r0,rm,density,except,agt,toDetect);
}

 public float MesureEnv(float rm)
 {
     return 0;
    		 //world.MesureEnv(this,rm);
 }
